...
window.drupalTranslations = {"strings":{"":{"Date":"Datum"}}};;
/**
* DO NOT EDIT THIS FILE.
* See the following change record for more information,
* https://www.drupal.org/node/2815083
...
!function(m,e,n){'use strict';m('html').removeClass('no-js').addClass('js'),e.behaviors.pvvs={attach:function(e,n){ModernizrCustom.objectfit||m(e).find('.field--type-image').each(function(){var e=m(this),n=e.find('img'),t=e.find('img').prop('src'),i=0!==e.parents('.slick__slide').length;t&&'text'===n.css('msUserSelect')&&!i&&(e.css('width',n.width()).css('height',n.height()),e.css('backgroundImage','url('+t+')').addClass('compat-object-fit'))})}},e.behaviors.sticky_menu={attach:function(e,n){void 0===window.stickyMenuInitialized&&(m(document).scroll(function(){var e=m(window).scrollTop(),n=m('body');0===e?n.removeClass('page-scrolled'):n.addClass('page-scrolled')}),window.stickyMenuInitialized=!0)}},e.behaviors.menu_trigger={attach:function(e,n){var t=m(e).find('#responsive-menu-trigger'),i=Snap('#responsive-menu-trigger svg'),a=m('#off-canvas').data('mmenu');t.length&&(a.bind('open:start',function(){i.select('path:nth-child(1)').animate({path:'M 12.972944,50.936147 51.027056,12.882035'},250),i.select('path:nth-child(2)').animate({opacity:0},250),i.select('path:nth-child(3)').animate({path:'M 12.972944,12.882035 51.027056,50.936147'},250)}),a.bind('close:start',function(){i.select('path:nth-child(1)').animate({path:'m 5.0916789,20.818994 53.8166421,0'},250),i.select('path:nth-child(2)').animate({opacity:1},250),i.select('path:nth-child(3)').animate({path:'m 5.0916788,42.95698 53.8166422,0'},250)}),t.click(function(){a.getInstance().vars.opened?a.close():a.open()}))}},e.behaviors.horizontal_menu={attach:function(e,n){var t=m(e).find('#block-horizontal-menu nav');function i(){m(document.body).removeClass('menu-is-open'),m(document.body).removeClass('menu-is-preparing'),m(document.body).removeClass('menu-level2-is-open'),m(l).removeClass('is-active'),o=!0,window.setTimeout(function(){s=o=a=!1},400)}if(0<t.length){var a=!1,s=!1,o=!1,c=m(e).find('#overlay'),d=m(e).find('.close-navigation'),l=m(t).find('.menu-item--level-0'),r=m(t).find('.menu-item--level-1'),u=m(t).find('.menu-item--level-2');m(l).hoverIntent({over:function(){o||(m(l).removeClass('is-active'),m(this).addClass('is-active'),a||(m(document.body).addClass('menu-is-preparing'),window.setTimeout(function(){m(document.body).addClass('menu-is-open')},50)))},interval:15}),m(r).hoverIntent({over:function(){o||(m(r).removeClass('is-active'),m(this).addClass('is-active'),s||(s=!0,window.setTimeout(function(){m(document.body).addClass('menu-lvl2-is-open')},50)))},interval:15}),m(u).hoverIntent({over:function(){o||(m(u).removeClass('is-active'),m(this).addClass('is-active'))},interval:15}),m(c).click(function(){i()}),m(d).click(function(){i()})}}},window.pvvsOnce=!0,e.behaviors.fix_ajax_focus={attach:function(e,n){window.pvvsOnce&&(m(document).ajaxStop(function(){void 0!==document.activeElement&&document.activeElement.blur()}),window.pvvsOnce=!1)}}}(jQuery,Drupal,drupalSettings);
